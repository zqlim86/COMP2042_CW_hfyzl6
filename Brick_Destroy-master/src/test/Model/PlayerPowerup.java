...
/**
 * PlayerPowerup class is Child Class of the Powerup class.
 * Responsible for all the implementations regarding the Player Powerup.
 */
public class PlayerPowerup extends Powerup {
    ...
    /**
     * PlayerPowerup constructor will create and set a position for the player powerup.
     * It will also read an image for the player powerup's in game visual. 
     */
    ...
    /**
     * impact method will detect if the ball has impacted the player powerup.
     ...
     * This method will set the paddleFace variable into a rectangle shape by calling the makePowerup() method.
     */
    @Override
