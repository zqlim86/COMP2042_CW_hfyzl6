...
/**
 * FirePowerup class is Child Class of the Powerup class. Responsible for all
 * the implementations regarding the Fire Powerup.
 */
public class FirePowerup extends Powerup {
	...
	/**
	 * impact method will detect if the ball has impacted the fire powerup. If True
	 ...
	 * set the fireFace variable into a rectangle shape by calling the makePowerup()
	 * method.
	 */
	@Override
