...
abstract public class Ball {
	...
	/**
	 * Ball constructor creates the ball as well as handles the ball movement Set
	 * the initial speed of ball of x and y direction to 0 at the start of the game.
	 *
	...
	/**
	 * setFireball is activated when the ball picks up the fireball powerup. Turns
	 * the ball into red color while the ball is still on fire.
	 * 
	...
	/**
	 * checkFire method is to check whether the current status of the ball is on
	 * fire or not.
	 * 
	...
	/**
	 * RemindTask method is to set the color of the ball back to yellow after the
	 * time duration ends.
	 *
	 */
	...
	/**
	 * setSpeed is Setter Method to set the speed of the ball in x and y axis
	 * direction.
	 * 
	...
	/**
	 * reverseX is to reverse the ball speed in x axis direction. This method is for
	 * making the ball bounce in different direction after impact.
	 */
	...
	/**
	 * reverseY is to reverse the ball speed in y axis direction. This method is for
	 * making the ball bounce in different direction after impact.
	 */
