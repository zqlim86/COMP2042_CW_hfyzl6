...
/**
 * CementBrick class is Child Class of the Brick class. Responsible for all the
 * implementations regarding the Cement Brick.
 */
public class CementBrick extends Brick {
	...
	/**
	 * repair method is to repair the Cement Bricks. Call parent class's repair()
	 * method. Resets crack of the cement bricks.
	 */
	public void repair() {
		super.repair();
		crack.reset();
