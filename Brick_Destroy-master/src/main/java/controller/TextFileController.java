...
/**
 * TextFileController is responsible for reading and writing data from text
 * files.
 */
public class TextFileController {
	...
	/**
	 * The method readFromFile read the score in the score.txt file and return an
	 * Integer array.
	 *
	...
	/**
	 * The method nReadFromFile read the name the name.txt file. and return a String
	 * array.
	 * 
	 * @throws IOException For TextFileController
