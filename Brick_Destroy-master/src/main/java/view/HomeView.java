...
/**
 * HomeMenu class comes after Intro class. Displays the Game Title, Start,
 * Instruction, Scoreboard, Exit;
 */
public class HomeView extends JComponent implements MouseListener, MouseMotionListener {
	...
	/**
	 * Constructor for class HomeMenu that construct HomeMenu as a JComponent Set
	 * the values for buttons size, font size, font style
	 *
	...
	/**
	 * paint is an Overridden Method from the JComponent class. Method to invoke the
	 * painting of the HomeMenu page. Calls the drawMenu method.
	 * 
	 * @param g Graphics
	 */
	...
	/**
	 * draws component on menuFace by calling the following method: drawContainer,
	 * drawText, drawButton set background image of home menu.
	 * 
	...
	/**
	 * draw the texts, greetings, gameTitle, credits in specific location on
	 * HomeMenu
	 * 
	 * @param g2d graphics2D object
	 */
	...
	/**
	 * draw the buttons, start, instruction, scoreboard, exit in order on HomeMenu
	 * screen
	 * 
	 * @param g2d graphics2D object
	 */
	...
	/**
	 * method is only activated when buttons are clicked if startButton is clicked
	 * then enableGameBoard is activated if instructButton is clicked, then
	 * enableInstructMenu is activated if scoreButton is clicked, then
	 * enableScoreboardMenu is activated if menuButton is clicked, then print
	 * "Goodbye + System.getProperty("user.name")" every click will play button
	 * sound effect.
	 * 
	...
	/**
	 * if either buttons are pressed, then set (start/menu/info)Clicked to true,
	 * then repaint the button to white
	 * 
	 * @param mouseEvent mouse action
	 */
	@Override
	...
	/**
	 * mouseMoved Method implements what should happen when the mouse hovers over
	 * the START or EXIT button and what the cursor should look like otherwise.
	 * 
	 * @param mouseEvent to indicate if a mouse action has occurred or not.
	 */
	@Override
