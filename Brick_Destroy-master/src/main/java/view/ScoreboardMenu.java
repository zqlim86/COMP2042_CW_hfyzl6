...
public class ScoreboardMenu extends JComponent implements MouseListener, MouseMotionListener {
	...
	/**
	 * Set the position of scoreboard menu. Set the font style and size. Set the
	 * back button's dimension.
	 * 
	 ...
	 * painting of the ScoreboardMenu page. Calls the drawMenu method.
	 * 
	 * @param g Graphics.
	 */
	...
	/**
	 * method is only activated when buttons are clicked if backButton is clicked,
	 * then play button sound effect and enableHomeMenu. every click will play
	 * button sound effect.
	 * 
	...
	/**
	 * if buttons are pressed, then set backClicked to true, then repaint the button
	 * to white
	 * 
	 * @param mouseEvent mouse action
	 */
