...
/**
 * Intro class is the class for the implementation of the starting page when the
 * game begins.
 */
public class IntroView extends JComponent implements KeyListener {
	...
	/**
	 * Intro constructor will play background music, create a rectangle, set the
	 * text font.
	 * 
	 ...
	 * painting of the Intro page. Calls the drawMenu method.
	 * 
	 * @param g Graphics
	 */
	...
	/**
	 * draws component on introFace by calling the following method: drawContainer,
	 * drawText set background gif.
	 * 
	 ...
	 * when a key is pressed. Enter = enableHomeMenu, also changing the background
	 * music.
	 * 
